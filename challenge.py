#day = input("Today's date?\n")
#brk = int(input("Breakfast calories?\n"))
#lun = int(input("Lunch calories?\n"))
#din = int(input("Dinner calories?\n"))
#snk = int(input("Snack calories?\n"))

#print("Calorie content for ", day,": ", brk+lun+din+snk, sep="")
